---
# Basic post metadata
# Layout is "single" by default from _config.yml defaults
# Author profile on, share & related enabled by defaults
...
# header:
#   teaser: /assets/images/teasers/hello.jpg
#   overlay_image: /assets/images/headers/hello.jpg
